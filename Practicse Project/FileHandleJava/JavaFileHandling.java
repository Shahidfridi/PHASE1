package FileHandleJava;
	...
	public class JavaFileHandling {
	    public static void main(String args[]) throws FileNotFoundException, IOException {
	        ...
	        System.out.println(" p for programming mode ");
	        System.out.println(" r for riding mode ");
	        System.out.println(" f for fun mode ");
	        ...
	        else if(s.equalsIgnoreCase("r")||s.equalsIgnoreCase("f"))
	        {
	            writingToFile(s);
