//CODE FOR VIRTUAL KEY FOR THE REPOSITORIES:
			   ...
			   private static final String LOGIC =
			    ...
			    void secondView() {
			        ...
			        try(Scanner scanner = new Scanner(System.in))
			        {
			            ...
			            switch (logic){
			                case '1' : {
			                    System.out.print("Please Enter which month of salary slip you want to Add : ");
			                    String filename = scanner.next().trim().toLowerCase();
			                    addFileMethod(filename);
			                    break;
			                }
			                case '2' : {
			                    System.out.print("Please Enter which month of salary slip  you want to Delete : ");
			                    String filename = scanner.next().trim();
			                    deleteFileMethod(filename);
			                    break;
			                }
			                case '3' : {
			                    System.out.print("Please Enter which month of salary slip you  want to Search For : ");
			                    String filename = scanner.next().trim();
			                    searchFileMethod(filename);
			                    break;
			                }
			                case '4' : {
			                    System.out.println("Going back to logic ");
			                    firstView();
			                    break;
			                }
